...
class AddMechanicReview extends StatefulWidget {
  const AddMechanicReview({Key? key}) : super(key: key);

  @override
  State<AddMechanicReview> createState() => _AddMechanicReviewState();
}

class _AddMechanicReviewState extends State<AddMechanicReview> {
  double _rating = 3;
